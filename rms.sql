...
CREATE TABLE `appointment` (            -- order
  `id` int(10) NOT NULL,
  `patient_name` varchar(255) NOT NULL, -- customar_mane
  `department` varchar(255) NOT NULL,   -- catagory
  `doctor_name` varchar(255) NOT NULL,  -- chef_name 
...
CREATE TABLE `departments` (      -- catagory
  `id` int(11) NOT NULL,
  `department_name` varchar(255) NOT NULL,   -- catagory_name
  `department_desc` varchar(255) NOT NULL    -- catagory_desc
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `doctor` (       -- chef
  ...
  `phone` varchar(20) NOT NULL,
  `image` text NOT NULL,
  `department` varchar(50) NOT NULL,   -- catagory_name
